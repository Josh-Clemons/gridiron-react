...
// Components
import ForgotPasswordButton from "../Buttons/ForgotPasswordButton.jsx";
...
export default function RegisterForm() {
    ...
    if (signupLoading) {
        return (
            <Box width={'100vw'}
                 sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100vh', mt: 5}}>
                <ThreeCircles
                    type="ThreeDots"
                    color="#5BC0BE"
                    height={100}
        ...
        <Container component="main" maxWidth="xs">
            ...
            >
                ...
                <Box component="form" onSubmit={handleSubmit} noValidate sx={{mt: 1}}>
                    ...
                    <Grid container>
                        <Grid item xs={12}>
                            <Link onClick={() => navigate('/login')} variant="body1"
